...
var loctest1 = new locations("Template1", "City", "0000 Vienna", "Streetname 000", "img/test.png");
var loctest2 = new locations("Template2", "City", "0000 Vienna", "Streetname 000", "img/test.png");
var loctest3 = new locations("Template3", "City", "0000 Vienna", "Streetname 000", "img/test.png");
var loctest4 = new locations("Template4", "City", "0000 Vienna", "Streetname 000", "img/test.png");
var loctest5 = new locations("Template5", "City", "0000 Vienna", "Streetname 000", "img/test.png");
var loctest6 = new locations("Template6", "City", "0000 Vienna", "Streetname 000", "img/test.png");
//restaurants
...
var resttest1 = new restaurants("RestTemplate1", "City", "0000 Vienna", "Streetname 000", "img/test.png", "+43(1)0000000", "Type", "www.website.com");
var resttest2 = new restaurants("RestTemplate2", "City", "0000 Vienna", "Streetname 000", "img/test.png", "+43(1)0000000", "Type", "www.website.com");
var resttest3 = new restaurants("RestTemplate3", "City", "0000 Vienna", "Streetname 000", "img/test.png", "+43(1)0000000", "Type", "www.website.com");
var resttest4 = new restaurants("RestTemplate4", "City", "0000 Vienna", "Streetname 000", "img/test.png", "+43(1)0000000", "Type", "www.website.com");
var resttest5 = new restaurants("RestTemplate5", "City", "0000 Vienna", "Streetname 000", "img/test.png", "+43(1)0000000", "Type", "www.website.com");
var resttest6 = new restaurants("RestTemplate6", "City", "0000 Vienna", "Streetname 000", "img/test.png", "+43(1)0000000", "Type", "www.website.com");
//events
...
var evetest1 = new events("EventTemplate1", "City", "0000 Vienna", "Strettname 000", "img/test.png", "Day, Date", "Time", "TicketPrice");
var evetest2 = new events("EventTemplate2", "City", "0000 Vienna", "Strettname 000", "img/test.png", "Day, Date", "Time", "TicketPrice");
var evetest3 = new events("EventTemplate3", "City", "0000 Vienna", "Strettname 000", "img/test.png", "Day, Date", "Time", "TicketPrice");
var evetest4 = new events("EventTemplate4", "City", "0000 Vienna", "Strettname 000", "img/test.png", "Day, Date", "Time", "TicketPrice");
var evetest5 = new events("EventTemplate5", "City", "0000 Vienna", "Strettname 000", "img/test.png", "Day, Date", "Time", "TicketPrice");
var evetest6 = new events("EventTemplate6", "City", "0000 Vienna", "Strettname 000", "img/test.png", "Day, Date", "Time", "TicketPrice");
console.log(array);
//array loop
for (var i in array) {
